function ProvenExperience() {
  return (
    ...
    >
      ...
      <p className="font-sans font-medium text-proven-subtitle leading-proven-subtitle text-accent">
        International Presence in most main emerging economies
      </p>
      <p className="font-sans font-normal text-proven-body leading-proven-body text-text-muted">
